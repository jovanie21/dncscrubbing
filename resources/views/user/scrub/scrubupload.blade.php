          ...
          <div class="row">
              <div class="col-sm-12">
                  <div class="card-box" id="uploadhide">
                      <form method="post" action="{{ url('user/userstorescrubfile') }}" class="form-validate-summernote"
                          id="myform" enctype="multipart/form-data">
                          @csrf
                          <div class="row form-group">
                              <div class="col-sm-2">
                                  <label>Scrub Type<i class="text-danger ">*</i></label>
                              </div>
                              <div class="col-sm-6">
                                  <div class="row">
                                      <span class="col-sm-6">
                          ...
                          <div class="row form-group">
                            <div class="col-sm-2">
                                <label class="">DNC List<i class="text-danger ">*</i></label>
                            </div>
                            <div class="col-sm-6">
                                  ...
                                  <tbody>
                                      @foreach ($exports as $export)
                                          <tr>
                                              ...
                                              <td>
                                                  {{ date('d-M-Y h:i:s A', strtotime($export->created_at)) }}
                                              </td>
                                              <td>
                                                  {{ date('d-M-Y h:i:s A', strtotime($export->updated_at)) }}
                                              </td>
                                              <td class="text-center">
                                                  ...
                                                  @else
                                                      <span style="display:flex; justify-content: space-evenly;">
                                                          <a class="btn btn-success"
                                                              href="{{ asset('dnc-seperated/' . $export->paths['active']) }}">DNC</a>
                                                          <a class="btn btn-danger"
                                                              href="{{ asset('dnc-seperated/' . $export->paths['inactive']) }}">NON-DNC</a>
                                                      </span>
                                                  @endif
                                              </td>
                                              <td>
                                                  <a href="{{ url('user/pdf/' . $export->id . '') }}"
