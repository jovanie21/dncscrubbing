                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="page-title-box">
                            <h4 class="page-title">Upload Internal File</h4>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box" id="uploadhide">
                            <form method="post" action="{{ url('user/uploaduserfile') }}" class="form-validate-summernote"
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="name" value="{{ old('name') }}"
                                            class="form-control" required="" placeholder="Region Name">
                                        <div class="text-danger">{{ $errors->first('name') }}</div>
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col-sm-2">
                                        <label class="">Upload Internal File<i class="text-danger ">*</i></label>
                                    </div>
                                    <div class="col-sm-6">
                                    ...
                                    <tbody>
                                        @foreach ($imports as $import)
                                            <tr>
                                                ...
                                                <td>
                                                    {{ date('d-M-Y h:i:s A', strtotime($import->created_at)) }}
                                                </td>
                                                <td>
                                                    {{ date('d-M-Y h:i:s A', strtotime($import->updated_at)) }}
                                                </td>
                                                <td>
