                    ...
                    <div class="card-box">
                      <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4">
                                <a href="{{ url('admin/user') }}" target="_blank">
                                <div class="card-box widget-box-two widget-two-primary">
                                    ...
                                    <div class="wigdet-two-content">
                                        ...
                                        <h2><span data-plugin="counterup">{{ $total_user }}</span>  </h2>
                                    </div>
                                </div>
                                </a>
                            </div><!-- end col -->
                            ...
                            <div class="col-lg-4 col-md-4">
                                <a href="{{  url('admin/dnclist')  }}" target="_blank">
                            ...
                            <div class="col-lg-4 col-md-4">
                                ...
                                <div class="card-box widget-box-two widget-two-danger">
                                    ...
                                    <div class="wigdet-two-content">
                                        ...
                                        <h2><span data-plugin="counterup">{{ $total_processed_files }}/{{ $total_files  }} </span>  </h2>
                                    </div>
                                </div>
                                </a>
                            </div><!-- end col -->
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="card-box widget-box-two widget-two-danger">
                                    ...
                                    <div class="wigdet-two-content">
                                        ...
                                        <h2><span data-plugin="counterup">{{ $total_federal }}</span>  </h2>
                                    </div>
                                </div>
                            </div> --><!-- end col -->
                            ...
                            <!-- <div class="col-lg-3 col-md-6">
                                <div class="card-box widget-box-two widget-two-success">
                                    ...
                                    <div class="wigdet-two-content">
                                        ...
                                        <h2><span data-plugin="counterup">{{ $total_litigator }}</span>  </h2>
                                    </div>
                                </div>
                            </div> --><!-- end col -->
                           <!--  <div class="col-lg-3 col-md-6">
                                <div class="card-box widget-box-two widget-two-info">
                                    ...
                                    <div class="wigdet-two-content">
                                        ...
                                        <h2><span data-plugin="counterup">{{ $total_internal }}</span>  </h2>
                                    </div>
                                </div>
                            </div> --><!-- end col -->
                            <!-- <div class="col-lg-3 col-md-6">
                                <div class="card-box widget-box-two widget-two-primary">
                                    ...
                                    <div class="wigdet-two-content">
                                        ...
                                        <h2><span data-plugin="counterup">{{ $total_wireless }}</span>  </h2>
                                    </div>
                                </div>
                            </div> -->
                            <!-- end col -->
