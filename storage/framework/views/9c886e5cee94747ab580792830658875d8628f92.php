...
<html lang="en">
  <head>
    ...
    <!-- CSS Link -->
    <link rel="stylesheet" href="<?php echo e(asset('webtheme/css/style.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('webtheme/css/responsive.css')); ?>" />
  </head>
  <body>
    ...
    <header id="header-section">
      ...
      <div id="fullnav" class="fullnav">
        <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">
          <img src="<?php echo e(asset('webtheme/img/menu-1.svg')); ?>" alt="menu" />
        </a>
      ...
      <nav class="navbar fixed-top navbar-expand-lg py-4 py-xxl-5 bg-white">
        <div class="container">
          ...
          >
            <img src="<?php echo e(asset('webtheme/img/menu-2.svg')); ?>" alt="menu" />
          </button>
          ...
          <div class="row text-center text-sm-start">
            <div class="col-sm-6 col-lg-4">
              <a href="<?php echo e(url('/')); ?>"
                ><img
                  src="<?php echo e(asset('webtheme/img/footer-logo.png')); ?>"
                  alt="footer-logo"
                  class="img-fluid"
              /></a>
    ...
    <div id="id01" class="modal">
      <form class="modal-content animate" action="<?php echo e(url('contact')); ?>" method="post">
      <?php echo csrf_field(); ?>
    ...
    ></script>
    <!-- Main JS -->
    <script src="<?php echo e(asset('webtheme/js/main.js')); ?>"></script>
  </body>
</html>
<?php /**PATH D:\xampp\htdocs\DNCscrubbing\resources\views/welcome.blade.php ENDPATH**/ ?>