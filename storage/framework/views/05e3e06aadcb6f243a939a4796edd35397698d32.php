                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box" id="uploadhide">
                            <form method="post" action="<?php echo e(url('admin/uploadadminfile')); ?>"
                                        ...
                                        <?php $__currentLoopData = $imports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $import): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <label
                                                        class="label label-<?php echo e($import->status == 'processed' ? 'primary' : ($import->status == 'processing' ? 'info' : 'danger')); ?>"><?php echo e(ucwords($import->status)); ?></label>
                                                </td>
                                                <td>
                                            
                                                    <?php echo e(date('m/d/Y h:i:s', strtotime($import->created_at->setTimezone('America/New_York')))); ?>

                                                </td>
                                                <td>
                                                    <?php echo e(date('m/d/Y h:i:s', strtotime($import->updated_at->setTimezone('America/New_York')))); ?>

                                                </td>
                                                <td>
                                                    <a href="<?php echo e($import->status == 'processed' ? url('admin/dnclist') . '?region=' . $import->name : '#'); ?>"
...
<?php $__env->startPush('footerscript'); ?>
    ...
    <script type="text/javascript">
        ...
        async function callfunction(id, i) {
            ...
            console.log(id, i);
            await $.ajax({
                url: '<?php echo e(url('admin/processabulkdminfile')); ?>/' + id,
                type: 'get',
                // dataType: "JSON",
                async: true,
                data: {
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\DNCscrubbing\resources\views/admin/uploadadmin.blade.php ENDPATH**/ ?>